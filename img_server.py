...
def video_test2():
    source_img_path = 'ionic-multi-menu/src/assets/images/src.png'
    target_video_path = 'ionic-multi-menu/src/assets/images/dst.mp4'
...
def image_test_auto():
    target_img_path = './ionic-multi-menu/src/assets/images/dst.png'
    output_dir = 'ionic-multi-menu/src/assets/images/demo'
    # output_dir = './results'
    source_img_path = './ionic-multi-menu/src/assets/images/src.png'
    merge_result = True
